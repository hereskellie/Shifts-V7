  ...
  enter1Field.keypress(function (e) {
    if (e.keyCode == 13) {
      ...
      //SAVE DATA TO FIREBASE AND EMPTY FIELD
		...
		dateMondayRef.child(dateMonday).set({emp1:emp1put1, 
    	emp2:emp2put1, 
    	emp3:emp3put1, 
    	emp4:emp4put1, 
    	emp5:emp5put1});
  ...
  enter3Field.keypress(function (e) {
    if (e.keyCode == 13) {
      ...
      //SAVE DATA TO FIREBASE AND EMPTY FIELD
		...
		dateWednesdayRef.child(dateWednesday).set({emp1:emp1put3, 
    	emp2:emp2put3, 
    	emp3:emp3put3, 
    	emp4:emp4put3, 
    	emp5:emp5put3});
  ...
  enter4Field.keypress(function (e) {
    if (e.keyCode == 13) {
      ...
      //SAVE DATA TO FIREBASE AND EMPTY FIELD
		...
		dateThursdayRef.child(dateThursday).set({
		emp1:emp1put4, 
    	emp2:emp2put4, 
    	emp3:emp3put4, 
    	emp4:emp4put4, 
  ...
  enter5Field.keypress(function (e) {
    if (e.keyCode == 13) {
      ...
      //SAVE DATA TO FIREBASE AND EMPTY FIELD
		...
		dateFridayRef.child(dateFriday).set({
		emp1:emp1put5, 
    	emp2:emp2put5, 
    	emp3:emp3put5, 
    	emp4:emp4put5, 
  ...
  enter6Field.keypress(function (e) {
    if (e.keyCode == 13) {
      ...
      //SAVE DATA TO FIREBASE AND EMPTY FIELD
		...
		dateSaturdayRef.child(dateSaturday).set({
		emp1:emp1put6, 
    	emp2:emp2put6, 
    	emp3:emp3put6, 
    	emp4:emp4put6, 
  ...
  enter7Field.keypress(function (e) {
    if (e.keyCode == 13) {
      ...
      //SAVE DATA TO FIREBASE AND EMPTY FIELD
		...
		dateSundayRef.child(dateSunday).set({
		emp1:emp1put7, 
    	emp2:emp2put7, 
    	emp3:emp3put7, 
    	emp4:emp4put7, 
